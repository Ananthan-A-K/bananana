    ...
    <div className="mx-auto max-w-6xl space-y-8 pb-8 px-4 bg-pitch-black">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 border-b border-charcoal-900 pb-8">
        <div className="space-y-1.5">
          <h1 className="text-3xl font-black tracking-tight text-warm-cream uppercase font-oldschoolgrotesk">My Complaints</h1>
          <p className="text-xs text-warm-cream/60 tracking-wide font-light">Manage and track your submitted campus issues.</p>
        </div>
        <Link
          to="/student/submit"
